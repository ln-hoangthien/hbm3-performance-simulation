...
// Get pkt type
EPktType CTRx::GetPktType() { return (this->ePktType); };

// Get TRx type
ETRxType CTRx::GetTRxType() { return (this->eTRxType); };

// Get pair
CPTRx CTRx::GetPair() { return (this->cpPair); };

// Get Ax pkt
CPAxPkt CTRx::GetAx() { return (this->cpAx); };

// Get R pkt
CPRPkt CTRx::GetR() { return (this->cpR); };

// Get W pkt
CPWPkt CTRx::GetW() { return (this->cpW); };

// Get B pkt
CPBPkt CTRx::GetB() { return (this->cpB); };

#ifdef CCI_ON
// Get AC pkt
CPACPkt CTRx::GetAC() { return (this->cpAC); }

// Get CD pkt
CPCDPkt CTRx::GetCD() { return (this->cpCD); }

// Get CR pkt
CPCRPkt CTRx::GetCR() { return (this->cpCR); }
#endif
...
EResultType CTRx::IsFirstValid() {
  ...
  if (((this->eState_D == ESTATE_TYPE_IDLE) || (this->eAcceptResult_D == ERESULT_TYPE_ACCEPT)) &&
      (this->eState == ESTATE_TYPE_IDLE)) {
...
EResultType CTRx::UpdateState() {
  ...
  //
  // // Debug
  // assert (this->eState		== ESTATE_TYPE_IDLE    or this->eState
  // == ESTATE_TYPE_BUSY); assert (this->eState_D	== ESTATE_TYPE_IDLE or
  // this->eState_D        == ESTATE_TYPE_BUSY); assert (this->eAcceptResult
  // == ERESULT_TYPE_ACCEPT or this->eAcceptResult   == ERESULT_TYPE_REJECT or
  // this->eAcceptResult   == ERESULT_TYPE_UNDEFINED); assert
  // (this->eAcceptResult_D== ERESULT_TYPE_ACCEPT or this->eAcceptResult_D ==
  // ERESULT_TYPE_REJECT or this->eAcceptResult_D == ERESULT_TYPE_UNDEFINED);
...
// Debug
EResultType CTRx::Display() { return (ERESULT_TYPE_SUCCESS); };
