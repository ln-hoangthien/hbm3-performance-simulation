...
// Get mem state pkt
SPMemStatePkt CQ::GetMemStatePkt() { return (this->spMemStatePkt); };
...
// Get UD type
EUDType CQ::GetUDType() { return (this->eUDType); };

// Get current occupancy
int CQ::GetCurNum() { return (this->nCurNum); };

// Get size
int CQ::GetMaxNum() { return (this->nMaxNum); };

// Get max waiting cycles among enties
int CQ::GetMaxCycleWait() { return (this->nMaxCycleWait); };
