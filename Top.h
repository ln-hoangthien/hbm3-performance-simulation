...
//------------------------------------------------------------
// Background traffic
// 	In following cases, transactions can be in buffers when simulation
...
//-------------------------------------------------------------
// #define DMA_ENABLE
// // MST background DMA traffic gen	FIXME
...
// Starvation
//-------------------------------------------------------------
// #define STARVATION_CYCLE		10000
// // Check Q, Tracker entry startvation. If exceeded, terminate sim
...
// #define SINGLE_FETCH
// #define BLOCK_FETCH
// // Full    1/1. 64 bytes (= 16 PTEs). Burst length 4. #define HALF_FETCH
// // Half    1/2. 32 bytes (= 8  PTEs). Burst length 2. #define QUARTER_FETCH
// // Quarter 1/4. 16 bytes (= 4  PTEs). Burst length 1.
...
// #define GROUP_SIZE			NUM_PTE_PTW
// // Number of PTEs ared group (CAMB)
...
//-------------------------------------------------------------
// #define IMG_HORIZONTAL_SIZE		1920 // pixels #define IMG_VERTICAL_SIZE
// 1088
...
//-------------------------------------------------------------
// #define AR_GEN_NUM			((IMG_HORIZONTAL_SIZE *
// IMG_VERTICAL_SIZE * BYTE_PER_PIXEL) / MAX_TRANS_SIZE) #define AW_GEN_NUM
// ((IMG_HORIZONTAL_SIZE * IMG_VERTICAL_SIZE * BYTE_PER_PIXEL) / MAX_TRANS_SIZE)
...
// #ifdef RGB
// #define PIXELS_PER_TRANS		(MAX_TRANS_SIZE / 4)
// // 16 pixels	// FIXME #endif #ifdef YUV #define PIXELS_PER_TRANS
// MAX_TRANS_SIZE				// 64 pixels #endif
...
//-------------------------------------------------------------
// #define SCENARIO_1
// // Camera preview #define SCENARIO_2
// // Rotated preview #define SCENARIO_5
// // Image scaling #define SCENARIO_6
// // Image blending #define SCENARIO_7
// // Rotated display
...
// #define ROTATION_LEFT_TOP_VER
// // Default rotation #define ROTATION_LEFT_BOT_HOR #define
// ROTATION_RIGHT_BOT_VER
...
//-------------------------------------------------------------
// #define BANK_FLIP // Patent #define BANK_FLIP_PLUS
// // Superpage based BFAM #define BANK_SHUFFLE
// // Bank Shuffling BSAM (on LIAM) #define SPLIT_BANK_SHUFFLE
// // Bank Shuffling (on SLIAM)

//-------------------------------------------------------------
// (Master) Tile addr map
//-------------------------------------------------------------
// #define AR_TILE
// // Tiled map #define AR_hTILE
// // Hierarchical tile #define AW_TILE #define AW_hTILE
...
// #define PAGE_SIZE		1024 // 1kB #define PAGE_SIZE		256
// // 512B
...
//	RCBMC: R, C, B, M, C
//
//	pRBC : Bank LSB = (Bank LSB) xor (Row LSB). Permuted from RBC.
// Zhang_MICRO'00. 	pRCBC: Bank LSB = (Bank LSB) xor (Row LSB). Permuted
// from RCBC. Kaseridis.
//---------------------------
#define RBC // R,B,C
// #define BRC // B,R,C #define RCBC
// // R,C1,B,C2 #define pRBC
// // Permutated RBC #define pRCBC
// // Permutated RCBC

// #define RMBC // R,M,B,C #define RBCMC
// // R,B,C,M,C #define RCBMC
// // R,C,B, M,C
...
// #define ROW_WIDTH		(32 - MEM_CH_WIDTH - BANK_WIDTH - COL_WIDTH)
// // Arch32
...
//-------------------------------------------------------------
typedef enum { ETRANS_DIR_TYPE_READ, ETRANS_DIR_TYPE_WRITE, ETRANS_DIR_TYPE_UNDEFINED } ETransDirType;
...
// Port Tx Rx
//-------------------------------------------------------------
typedef enum { ETRX_TYPE_TX, ETRX_TYPE_RX, ETRX_TYPE_UNDEFINED } ETRxType;
...
// Arbiter
//-------------------------------------------------------------
typedef enum { EARB_TYPE_RR, EARB_TYPE_FixedPriority, EARB_TYPE_UNDEFINED } EArbType;
...
//-------------------------------------------------------------
// typedef enum{
//	EADDR_MAP_TYPE_LIAM					// Linear
// Address Map 	EADDR_MAP_TYPE_SLIAM					// Split
// linear Address Map (Map0, Map1 - both LIAM) 	EADDR_MAP_TYPE_BFAM_BANK_FLIP,
//// Bank Interleaed linear. Samsung patent
/// EADDR_MAP_TYPE_BFAM_BANK_FLIP_PLUS, / BFAM EADDR_MAP_TYPE_BFAM_BANK_SHUFFLE,
///// BSAM
//
//	EADDR_MAP_TYPE_TILE					// Tiled
//	EADDR_MAP_TYPE_hTILE					// Hierarchical
// tiled
//
...
//-------------------------------------------------------------
// typedef enum{
//	EOP_TYPE_RASTER_SCAN,					// Row-major
// horizontal
//
//	EOP_TYPE_ROTATION,					// Column-major
// vertical. Start left top
//
//	EOP_TYPE_ROTATION_LEFT_BOT_VER
//	EOP_TYPE_ROTATION_RIGHT_BOT_HOR
//	EOP_TYPE_ROTATION_RIGHT_TOP_VER
//	EOP_TYPE_ROTATION_LEFT_TOP_VER				// Default
// rotation. Start left top 	EOP_TYPE_ROTATION_LEFT_BOT_HOR
//	EOP_TYPE_ROTATION_RIGHT_BOT_VER
//
//	EOP_TYPE_RANDOM,					// Random
// address
//
//	EOP_TYPE_CNN,						// Convolutional
// neural network (block-level convolved read, write)
//
//	EOP_TYPE_JPEG,						// 8x8
// Block-level linear
//
...
//	EMEM_MAP_TYPE_RCBC,					// R,C,B,C
//(cache line bank interleave) 	EMEM_MAP_TYPE_pRBC,
//// R,B,C (B permuted) 	EMEM_MAP_TYPE_pRCBC,
//// R,C,B,C (B permuted)
//
...
int64_t GetAddr_AMap_Global(int64_t nRow, int nMemCh, int nBank,
                            int nCol); // RBCMC,RCBMC, RMBC
